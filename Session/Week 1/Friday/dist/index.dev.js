...
//Deklarasi Variable
var x = 10; //Initialisai Variable
// console.log(x);

var number = 100;
var nUmBeR = 100;
var NUMBER = 100; //Penulisan Variable yg salah
// var 1 = 1;
// var 7angka = 0;
// var list products = [];
...
var isHot = true;
var isWindy = false;
var isCold = true; //Null

var n = null;
var N = 0; //Undefined

var box = undefined; //Javascript all about object
//Object 
...
var mahasiswa = {
  ...
  ipk: 3.21,
  isAbleCoding: true,
  computeMath: function computeMath() {
    console.log(100);
  }
}; //Operasi Math
...
var a = 5;
var b = 7;
var total = a + b; // console.log(total)

var kata1 = "10";
var kata2 = true;
var kata3 = kata1 + kata2; // console.log(typeof kata3)
...
var apple = "Apple";
var cherry = "Cherry";
var banana = "Banana"; // var fruits = new Array()

var fruits = ["Apple", "Cherry", "Banana", "Melon", "Grapes"]; // console.log(typeof fruits)
...
var arrayInArray = [["Apple", "Cherry"], ["Potato", "Broccoli"], ["Meat", "Fish"]];
var arrayInObject = {
  fruits: ["Apple", "Cherry"],
